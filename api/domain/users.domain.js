class UsersDomain {
    ...
    getGrocery(params, response) {
        response.json([
            ...
            // { "type" : "Mobiles","isActive": true, "src": "oppoF11.jpg", "price": "19,083.00","originalPrice": "19,093.00", "discount" : "-2%", "totalDiscount" : "10" , "ProductName": "Oppo F11" }, 
            // { "type" : "Mobiles","isActive": true, "src": "iphone11.jpg", "price": "1,40,300.00","originalPrice": "1,40,310.00", "discount" : "-2%", "totalDiscount" : "10", "ProductName": "Apple iphone11 Pro" },
            // { "type" : "Mobiles","isActive": true, "src": "realmeXT.jpg", "price": "16,989.00","originalPrice": "16,999.00", "discount" : "-2%", "totalDiscount" : "10", "ProductName": "Realme XT" },
            // { "type" : "Mobiles","isActive": true, "src": "realme-x50-pro.jpg", "price": "48,900.00","originalPrice": "48,910.00", "discount" : "-2%", "totalDiscount" : "10", "ProductName": "Realme X50 Pro" },

            // { "type" : "Electronics","isActive": true, "src": "keyboad.jpg", "price": "616.00","originalPrice": "626.00", "discount" : "-2%", "totalDiscount" : "10" , "ProductName": "HP 100 wired USB Keyboard" }, 
            // { "type" : "Electronics","isActive": true, "src": "mouse.jpg", "price": "625.00","originalPrice": "635.00", "discount" : "-2%", "totalDiscount" : "10" , "ProductName": "Dell WM126 Wireless Optical Mouse (Black)" },
            // { "type" : "Electronics","isActive": true, "src": "boat.jpg", "price": "399.00","originalPrice": "409.00", "discount" : "-2%", "totalDiscount" : "10" , "ProductName": "Boat BassHeads 235 Bass Earphones" },
            // { "type" : "Electronics","isActive": true, "src": "JBLTune.jpg", "price": "5,999.00","originalPrice": "6,009.00", "discount" : "-2%", "totalDiscount" : "10" , "ProductName": "JBL TUNE 750BTNC" }
    ...
    getNumberOfItems(params, response) {
        response.json([
            ...
            { "CategoryType": "Electronics", "rediredtToPage" : "/user-tabs/electronics", "src":"JBLTune.jpg"},
            { "CategoryType": "Mobiles", "rediredtToPage" : "/user-tabs/mobiles", "src":"oppoF11.jpg"}
        ]);
    }
}
